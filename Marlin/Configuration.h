...
#define CUSTOM_MACHINE_NAME "TM3D E5 Plus-D"
...
#define Z_SAFE_HOMING
  ...
  #else
    #define Z_SAFE_HOMING_X_POINT 300 + HOMING_ADD    // X point for Z homing when homing all axis (G28).
    #define Z_SAFE_HOMING_Y_POINT 341 + HOMING_ADD    // Y point for Z homing when homing all axis (G28).
  #endif
#endif
